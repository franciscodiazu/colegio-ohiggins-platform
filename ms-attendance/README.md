...
- Total Tests: 107
- Cobertura de codigo: ~84% (Lineas), ~89% (Metodos), ~75% (Ramas)
- Clases criticas testeadas: ControladorAsistenciaTest, ServicioAsistenciaTest, ClienteEstudiantesResilienceTest, AtrasoFactoryTest, PresenteFactoryTest, RepositorioRegistroAsistenciaDataJpaTest.
