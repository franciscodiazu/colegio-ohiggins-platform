...
function a({ title: e, subtitle: t }) {
	return /* @__PURE__ */ (0, i.jsxs)("header", {
		className: "coh-header",
		children: [/* @__PURE__ */ (0, i.jsx)("h1", { children: e }), t ? /* @__PURE__ */ (0, i.jsx)("p", { children: t }) : null]
	});
}
//#endregion
//#region src/components/TopNavTabs.jsx
function o({ items: e, activeKey: t, onChange: n }) {
	return /* @__PURE__ */ (0, i.jsx)("nav", {
		className: "coh-nav-bar",
		"aria-label": "Navegacion principal",
		children: e.map((e) => /* @__PURE__ */ (0, i.jsx)("button", {
			type: "button",
			className: `coh-nav-btn ${t === e.key ? "active" : ""}`,
			onClick: () => n(e.key),
			children: e.label
		}, e.key))
	});
...
//#endregion
export { a as SchoolHeader, o as TopNavTabs };
